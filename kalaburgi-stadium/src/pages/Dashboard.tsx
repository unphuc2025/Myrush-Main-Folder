        ...
        <div className="min-h-screen bg-gray-50 font-sans pb-6 md:pb-12">
            ...
            <div className="pt-20 md:pt-24 px-4 md:px-8 max-w-7xl mx-auto">
                ...
                <div className="flex flex-col gap-8">
                    ...
                    >
                        <div className="absolute inset-0 bg-[url('/hero.png')] bg-cover bg-center opacity-70 group-hover:scale-105 transition-transform duration-700"></div>
                        ...
                        <div className="absolute inset-0 flex flex-col justify-center px-6 md:px-12 z-10">
                            ...
                            <div className="flex items-center gap-2 mb-4">
                                <span className="px-2 py-0.5 rounded-md bg-primary/20 border border-primary/30 text-[10px] font-bold text-primary uppercase tracking-tighter">
                                    Kalaburgi Stadium
                                </span>
                            </div>
                            <button className="bg-white text-black font-bold uppercase tracking-widest text-[10px] md:text-sm px-6 md:px-8 py-3 md:py-4 rounded-full w-fit hover:bg-black hover:text-white transition-all shadow-glow flex items-center gap-2">
                                Find Slots <FaRunning className="text-base md:text-lg" />
                            </button>
                        </div>
                    </motion.div>
