...
function AddAmenityForm({ onCancel, onSave, initialData = null }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            let result;
            if (initialData) {
                result = await amenitiesApi.update(initialData.id, submitData);
            } else {
                result = await amenitiesApi.create(submitData);
            }
    ...
    return (
        <div className="bg-white rounded-lg">
            <div className="flex items-center gap-4 mb-6 pb-4 border-b border-slate-200">
                ...
                <h2 className="text-xl font-semibold text-slate-800">{initialData ? 'Edit Amenity' : 'Add Amenity'}</h2>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6 max-w-2xl">
                ...
                <div>
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div className="text-sm text-slate-500 pt-2">
                            <p>Upload an icon or image for this amenity.</p>
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            placeholder="e.g., Wi-Fi, Parking, Showers"
                ...
                <div className="flex items-center justify-end gap-4 pt-6 border-t border-slate-200">
                    ...
                    >
                        {isSubmitting ? 'Saving...' : (initialData ? 'Update Amenity' : 'Save Amenity')}
                    </button>
                </div>
            </form>
        </div>
