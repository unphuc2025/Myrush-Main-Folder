        ...
        <form onSubmit={handleSubmit} className="flex flex-col h-full bg-white">
            ...
            <div className="flex-1 overflow-y-auto px-1 py-2 space-y-8">
                ...
                <div className="space-y-6">
                    {/* Name */}
                    <div>
                        <label className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2 ml-1">Amenity Name</label>
                        <div className="relative group">
                            <Star className="absolute left-4 top-3.5 h-5 w-5 text-slate-400 group-focus-within:text-green-600 transition-colors" />
                            <input
                                type="text"
                                value={formData.name}
