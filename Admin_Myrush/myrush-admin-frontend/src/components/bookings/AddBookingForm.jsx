                    ...
                    <div>
                        ...
                        <div className="relative group">
                            ...
                            <input
                                ...
                                className="w-full pl-12 pr-4 py-3.5 bg-white border-2 border-slate-200 rounded-xl focus:border-slate-800 focus:ring-0 outline-none transition-all font-medium text-lg shadow-sm hover:border-slate-300"
                                required
                            />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="relative group">
                            ...
                            <select
                                ...
                                className="w-full pl-12 pr-10 py-3.5 bg-white border-2 border-slate-200 rounded-xl focus:border-slate-800 focus:ring-0 outline-none transition-all font-medium text-lg appearance-none shadow-sm hover:border-slate-300 text-slate-900"
                            >
                ...
                <div>
                    ...
                    <div className="relative group">
                        ...
                        <select
                            ...
                            className="w-full pl-12 pr-10 py-3.5 bg-white border-2 border-slate-200 rounded-xl focus:border-slate-800 focus:ring-0 outline-none transition-all font-medium text-lg appearance-none shadow-sm hover:border-slate-300"
                        >
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <div className="relative">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full pl-7 pr-3 py-2.5 border-2 border-slate-200 rounded-xl text-sm font-bold focus:ring-0 focus:border-green-500 outline-none transition-all"
                                                />
                                            </div>
                                        </div>
