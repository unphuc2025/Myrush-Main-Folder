...
const Venues = () => {
  ...
  const permissions = (() => {
    try {
      ...
      return adminInfo.permissions?.['Manage Branch'] || {};
    } catch { return {}; }
  })();
    ...
    return (
      <Layout onLogout={() => {
        ...
        <div className="flex flex-col items-center justify-center min-h-[70vh] gap-4 text-center">
          ...
          <p className="text-slate-500 max-w-sm">You do not have permission to manage branches. Please contact your administrator.</p>
        </div>
      </Layout>
    );
  }
