...
const Amenities = () => {
    ...
    const permissions = (() => {
        try {
            ...
            return adminInfo.permissions?.['Manage Amenities'] || {};
        } catch { return {}; }
    })();
        ...
        return (
            <Layout onLogout={() => {
                ...
                <div className="flex flex-col items-center justify-center min-h-[70vh] gap-4 text-center">
                    ...
                    <p className="text-slate-500 max-w-sm">You do not have permission to manage amenities. Please contact your administrator.</p>
                </div>
            </Layout>
        );
    }
    ...
    return (
        <Layout onLogout={() => {
            ...
            <div className="mb-6">
                ...
                <p className="text-sm text-slate-500">Manage global amenities for your venues</p>
            </div>
