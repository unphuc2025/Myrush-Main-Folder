...
const Cities = () => {
    ...
    const permissions = (() => {
        try {
            ...
            return adminInfo.permissions?.['City Management'] || {};
        } catch { return {}; }
    })();
        ...
        return (
            <Layout onLogout={() => {
                ...
                <div className="flex flex-col items-center justify-center min-h-[70vh] gap-4 text-center">
                    ...
                    <p className="text-slate-500 max-w-sm">You do not have permission to manage cities. Please contact your administrator.</p>
                </div>
            </Layout>
        );
    }
    ...
    return (
        <Layout onLogout={() => {
            ...
            <div className="mb-6">
                ...
                <p className="text-sm text-slate-500">Manage cities where you operate</p>
            </div>
