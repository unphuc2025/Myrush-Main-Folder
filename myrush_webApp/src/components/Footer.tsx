...
export const Footer: React.FC = () => {
    return (
        <footer className="bg-zinc-900 border-t border-white/10 py-6 md:py-8 w-full px-6">
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-6 text-white text-sm">
                    <div className="col-span-1 md:col-span-2">
                        <img src="/Rush-logo.webp" alt="Rush" className="h-32 mb-6 object-contain" />
                    ...
                    <div className="col-span-1 md:col-span-1">
                        <div className="text-xs text-gray-400 space-y-1">
                            <p># 643/2, 12th Main Rd, Rajajinagar, Bengaluru</p>
